defmodule PdfTipsElixir.Workers.GenerateEmbeddingsWorker do
  @moduledoc """
  ...
  alias PdfTipsElixir.Services.EmbeddingService
  ...
  def perform(%Oban.Job{args: %{"document_id" => document_id}}) do
    ...
    document = PdfTipsElixir.Knowledge.get_document(document_id)

...
#
#     PHX_SERVER=true bin/pdf_tips_elixir start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :pdf_tips_elixir, PdfTipsElixirWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :pdf_tips_elixir, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :pdf_tips_elixir, PdfTipsElixir.Mailer,
